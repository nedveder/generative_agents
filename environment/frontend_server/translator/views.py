...
def home(request):
  ...
  # Check if backend is running (files should exist)
  if not os.path.exists(f_curr_step) or not os.path.exists(f_curr_sim_code):
    context = {}
  ...
  # Don't delete curr_step.json - keep it so page can be refreshed
