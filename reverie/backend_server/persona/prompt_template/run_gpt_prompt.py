...
from persona.prompt_template.prompts.utils import get_random_alphanumeric, extract_first_json_dict
from utils import ACTIVE_COMPLETION_MODEL
...
def run_gpt_prompt_wake_up_hour(persona, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": ACTIVE_COMPLETION_MODEL, "max_tokens": 5, 
...
def run_gpt_prompt_generate_hourly_schedule(persona, 
  ...
  # gpt_param = {"engine": ACTIVE_COMPLETION_MODEL, "max_tokens": 15, 
...
# extract_first_json_dict moved to prompts/utils.py
